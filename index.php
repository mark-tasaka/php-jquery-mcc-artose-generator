...
<html>
<head>
<title>Launch Page: Artose Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
		<form action="" id ="artoseForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Artose, Level 1</option>
				<option value="02">Artose, Level 2</option>
				<option value="03">Artose, Level 3</option>
				<option value="04">Artose, Level 4</option>
				<option value="05">Artose, Level 5</option>
				<option value="06">Artose, Level 6</option>
				<option value="07">Artose, Level 7</option>
				<option value="08">Artose, Level 8</option>
				<option value="09">Artose, Level 9</option>
				<option value="10">Artose, Level 10</option>
			  </select>
        ...
        {
            $("#artoseForm").attr('action', "artose/artose"+ $("#level").val() +  ".php");
        });

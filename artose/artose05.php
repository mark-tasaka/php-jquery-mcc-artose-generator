...
<html>
<head>
<title>Iconic NPC Artose Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_artose.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_artose_post.css">
...
<!-- JQuery -->
  <img id="character_sheet"/>
   <section>
    ...
    <span id="additionalLanguages"></span>
       ...
       <span id="zeroLevelMutantAppearance">Hands: Prehensile Claws</span>
  ...
  <script>
	...
	/*
	 Character() - Artose Character Constructor
	*/
	function Character() {
    ...
    let mutant = getArtose();
		...
		let mutantCharacter = {
			...
			"fort": 1 + mutant.fort + staminaModifier + adjustFort(birthAugur,luckModifier),
			...
			"speed": 55 + addLuckToSpeed(birthAugur, getLuckModifier(luck)) + "'",
			"modifiedSpeed": 55 - <?php echo $speedReduction ?> + addLuckToSpeed(birthAugur, getLuckModifier(luck)) + "'",
            ...
            "acNoArmoured": 3 + baseArmourClass,
    ...
    /*getArtose() return the statistics for the Manimal per level*/  
    function getArtose() {
		let mutant = [
	...
	return mutant[4]; 
       ...
       let imgData = "images/artose_character_sheet.png";
